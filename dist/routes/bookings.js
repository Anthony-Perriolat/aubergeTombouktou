...
const BookingCrlt = __importStar(require("../controllers/bookings"));
...
router.post('/', authMiddleware_1.authMiddleware, BookingCrlt.createBooking);
router.put('/:id', authMiddleware_1.authMiddleware, BookingCrlt.updateBooking);
router.delete('/:id', authMiddleware_1.authMiddleware, BookingCrlt.deleteBooking);
